      ...
      >
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-[#a1a1aa] font-semibold">STEP 2 of 3</span>
            <span className="text-sm text-[#a1a1aa]">Almost there!</span>
          </div>
        ...
        {/* Quick Suggestions */}
        <div className="mb-6">
          <h3 className="text-sm font-semibold text-[#a1a1aa] mb-3">💡 QUICK START IDEAS</h3>
              ...
              <motion.button
                ...
                className={`text-left p-4 rounded-xl border-2 transition-all ${
                  selectedSuggestion === index
                    ...
                    : 'glass border-white/[0.08] hover:border-[#22d3ee] hover:bg-[#111113]'
                }`}
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="text-xs text-[#a1a1aa] font-semibold mb-1">{suggestion.category}</div>
                    <div className="text-white text-sm line-clamp-2">{suggestion.text}</div>
                  </div>
                  {selectedSuggestion === index && (
                    <div className="ml-2 bg-[#22d3ee] rounded-full p-1">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className={`text-sm font-mono ${charCount > maxChars ? 'text-red-400' : 'text-[#a1a1aa]'}`}>
              {charCount} / {maxChars}
            </span>
          </div>
          <textarea
            ...
            rows={6}
            className="w-full bg-[#18181b] border border-white/[0.06] rounded-xl px-4 py-3 text-white placeholder-[#52525b] focus:border-[#22d3ee] focus:outline-none resize-none"
          />
          {charCount > maxChars && (
        ...
        <div className="mb-8">
          ...
          {!imagePreview ? (
            <label className="block cursor-pointer">
              <div className="glass border-2 border-dashed border-white/[0.08] rounded-xl p-8 text-center hover:border-[#22d3ee] hover:bg-[#18181b] transition-all">
                <div className="text-4xl mb-2">🖼️</div>
                <p className="text-white font-semibold mb-1">Click to upload an image</p>
                <p className="text-sm text-[#a1a1aa]">PNG, JPG, GIF up to 10MB</p>
              </div>
              <input
                type="file"
                accept="image/*"
            ...
            <div className="relative glass border border-white/[0.08] rounded-xl p-4">
              <img
                src={imagePreview}
                alt="Preview"
              ...
              <button
                ...
                className="absolute top-6 right-6 bg-red-500 hover:bg-red-600 text-white rounded-full p-2 transition-all"
              >
