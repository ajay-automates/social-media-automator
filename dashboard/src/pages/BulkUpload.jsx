      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <button
            ...
            className="bg-white dark:bg-gradient-to-r dark:from-green-600 to-emerald-600 text-gray-900 dark:text-white px-6 py-3 rounded-xl font-bold hover:opacity-90 transition shadow-lg flex items-center gap-2"
          >
